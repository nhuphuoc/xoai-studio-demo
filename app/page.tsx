        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-16">
            ...
            <p className="text-foreground/70 text-lg max-w-2xl mx-auto">
              Những sản phẩm diễn họa 3D chất lượng cao từ đội ngũ và học viên
            </p>
          </div>
          ...
          >
            {[
              ...
              <div
                key={index}
                className="group relative glassmorphism rounded-xl overflow-hidden cursor-pointer animate-scale-in border border-white/10 hover:border-primary/60 transition-all duration-500"
                style={{
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/30 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                  <div className="absolute bottom-0 left-0 right-0 p-4">
                    ...
                    <div className="flex items-center gap-2">
                      <span className="px-2 py-0.5 bg-primary/20 text-primary text-xs rounded-full border border-primary/50">
                        3ds Max
                      </span>
                      <span className="px-2 py-0.5 bg-accent/20 text-accent text-xs rounded-full border border-accent/50">
                        Vray
                      </span>
                    </div>
                  </div>
      ...
      <section className="py-24 bg-background relative overflow-hidden">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">
              Sản Phẩm Từ Học Viên
            </h2>
            <p className="text-foreground/70 text-lg max-w-2xl mx-auto">
              Những tác phẩm xuất sắc từ các khóa học tại Xoi Studio
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              {
                name: "Nguyễn Văn A",
                course: "Khóa học 3ds Max Pro",
                image: "https://images.unsplash.com/photo-1600607687920-4e2a09cf159d?w=600&q=80",
                avatar: "https://i.pravatar.cc/150?img=1",
                testimonial: "Khóa học rất bổ ích, giảng viên tận tâm. Sau 3 tháng tôi đã có thể làm được những dự án thực tế.",
              },
              {
                name: "Trần Thị B",
                course: "AutoCAD Kiến Trúc",
                image: "https://images.unsplash.com/photo-1600210491892-03d54c0aaf87?w=600&q=80",
                avatar: "https://i.pravatar.cc/150?img=2",
                testimonial: "Nội dung chi tiết, dễ hiểu. Tôi đã chuyển nghề và có thu nhập ổn định nhờ kỹ năng học được.",
              },
              {
                name: "Lê Minh C",
                course: "Vray Rendering Master",
                image: "https://images.unsplash.com/photo-1600566753376-12c8ab7fb75b?w=600&q=80",
                avatar: "https://i.pravatar.cc/150?img=3",
                testimonial: "Chất lượng render của tôi đã cải thiện rõ rệt. Giờ tôi tự tin nhận các dự án lớn.",
              },
            ].map((item, index) => (
              <div
                key={index}
                className="group glassmorphism rounded-xl overflow-hidden hover:border-accent transition-all duration-500 animate-scale-in"
                style={{ animationDelay: `${index * 100}ms` }}
              >
                {/* Image */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                <div
                  key={i}
                  className={`glassmorphism rounded-2xl p-6 border ${item.color === "primary" ? "border-primary/20 hover:border-primary/50 hover:shadow-[0_0_25px_rgba(0,212,255,0.1)]" : "border-accent/20 hover:border-accent/50 hover:shadow-[0_0_25px_rgba(57,255,20,0.1)]"} transition-all duration-400 group cursor-default`}
                >
                  <div className="text-3xl mb-3">{item.icon}</div>
                  <div className={`text-3xl font-bold mb-1 ${item.color === "primary" ? "text-primary" : "text-accent"}`}>
                    {item.value}
                  </div>
